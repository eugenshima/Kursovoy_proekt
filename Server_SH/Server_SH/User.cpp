...
void MENU::printfHistoryN(int i, Server& obj)
{
	int ch = 0;
	int shect = 0;
	char buf[100];
...
void MENU::printf_moneyN(int i, Server& obj)
{
	int sum;
	char buf[100];
...
void MENU::replenih_account(Server& obj, int i)
{
	char buf[100];
	int sum;
	recv(obj.GetNewConnection(), buf, sizeof(buf), 0);
...
void MENU::opinionExpert(Server& obj, int i)
{
	int cof = 0;
	char nameExpert[100];
	float rang[100][100];
...
void MENU::replenish(Server& obj, int i)
{
	int chek = 0;
	int cheks;
	char chakc[100];
...
void MENU::receptionExpert(int i, Server& obj)
{
	MENU us;
...
void MENU::reception(int i, Server& obj)
{
	MENU us;
...
int MENU::AutorizationAdmin(Server& obj)
{
	int check = 0;
...
void MENU::addClient(Server& obj)
{
	int check = 0;
	char msg[100];
	Human obj1;
...
void MENU::addExpert(Server& obj)
{
	int check = 0;
	char msg[100];
	Human obj1;
...
int MENU::AutorizationClient(Server& obj)
{
	int check = 0;
	char log[100], pas[100];
	recv(obj.GetNewConnection(), log, sizeof(log), 0);
...
int MENU::AutorizationExpert(Server& obj)
{
	int check = 0;
	char log[100], pas[100];
	recv(obj.GetNewConnection(), log, sizeof(log), 0);
...
void MENU::TakeProp(Server& obj, char* buf, int client)
{
	int check = 0;
...
void MENU::addProp(Server& obj, int i)
{
...
void MENU::addRating(Server& obj, int i)
{
	printf_infoProp(obj);
...
void MENU::delClient(Server& obj)
{
	int check = 0;
	char log[100], pas[100];
	recv(obj.GetNewConnection(), log, sizeof(log), 0);
...
void MENU::delExpert(Server& obj)
{
	int check = 0;
	char log[100], pas[100];
	recv(obj.GetNewConnection(), log, sizeof(log), 0);
...
void MENU::findAdmin(Server& obj)
{
	int check = 0;
	char log[100], tel[100];
	recv(obj.GetNewConnection(), log, sizeof(log), 0);
...
void MENU::findExpert(Server& obj)
{
	int check = 0;
	char log[100], tel[100];
	recv(obj.GetNewConnection(), log, sizeof(log), 0);
...
void MENU::PrintfStatistick(Server& obj)
{
	int che;
	char bue[100];
	if (vecStats.size() == 0)
...
void MENU::printf_infoProp(Server& obj)
{
...
void MENU::printf_infoClient(Server& obj)
{
	char buf[100];
	int size;
	size = vecHuman.size();
...
void MENU::printf_infoAdmin(Server& obj)
{
	char buf[100];
	int size;
	size = vecAdmin.size();
...
void MENU::printf_infoExpert(Server& obj)
{
	char buf[100];
	int size;
	size = vecExpert.size();
...
void MENU::save_info_Stats()
{
	FileCreator obj;
	obj.write_vector_Statistick(vecStats);
}

void MENU::save_info_bank()
{
	FileCreator obj;
...
void MENU::seve_info_Client()
{
	FileCreator obj;
	obj.write_vector_User(vecHuman);
}

void MENU::save_info_Admin()
{
	FileCreator obj;
	obj.write_vector_Admin(vecAdmin);
}

void MENU::save_info_Expert()
{
	FileCreator obj;
	obj.write_vector_Expert(vecExpert);
}

void MENU::save_info_Rating()
{
	FileCreator file;
