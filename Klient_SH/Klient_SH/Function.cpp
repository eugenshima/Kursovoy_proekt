...
void assesmentExpert(Server& obj)
{
	...
	else
	{
		...
		cout << "кол-во кв. метров : " << procent << endl;
		cout << "стоимость : " << sum << endl;
	}
}
...
void addProp(Server& obj)
{
	...
	cout << "Наименование недвижимости : " << nameCredit << endl;
	cout << "кол-во кв. метров : " << kvmetr << endl;
	system("pause");
	system("cls");
}
...
void PrintfUserInfo(Server& obj)
{
	...
	size = atoi(buf);
	system("cls");
	cout << "имя \t" << "номер телефона \t" << "паспортные д. \t" << "логин \t" << "пароль \t" << "денег в недв." << endl;
	for (int i = 0; i < size; i++)
	{
...
void PrintfAdminInfo(Server& obj)
{
	...
	size = atoi(buf);
	system("cls");
	cout << "имя \t" << "номер телефона \t" << "паспортные д. \t" << "логин \t" << "пароль \t" << endl;
	for (int i = 0; i < size; i++)
	{
		char name[100], tel[100], pas_info[100], login[100], password[100], msg[100];
		float cash;
...
void PrintfIntoCredit(Server& obj)
{
	...
	recv(obj.getConnetc(), msg, sizeof(msg), 0);
	check = atoi(msg);
	cout << "№ \t" << "Наименование недвижимости \t" << "Кол-во кв. метров \t" << "стоимость \t" << endl;
...
void PriintfStatistick(Server& obj)
{
	...
	else
	{
		...
		for (int i = 0; i < check; i++)
		{
			...
			sum = atoi(bufsum);
			cout << "###########################################################" << endl;
			cout << "Дата выбора недвижимости :" << date << endl;
			cout << "Имя :" << nameClient << endl;
			cout << "Паспортные данные :" << pas_info << endl;
			cout << "Номер телефона  :" << tel << endl;
			cout << "Наименование вида недвижимости :" << nameCredit << endl;
			cout << "кв. метры :" << procen << endl;
			cout << "стоимость :" << sum << "руб." << endl;
